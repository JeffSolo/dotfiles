...
function setUpAppBindings()
  ...
  hyperFocusOrOpen(',', 'WhatsApp')
  hyperFocusOrOpen('.', 'Telegram')
  hyperFocusOrOpen('s', 'Code')
  hyperFocusOrOpen('space', 'iTerm2')
  hyperFocusOrOpen('w', 'Google Play Music Desktop Player')
  hyperFocus('d', 'Google Chrome', 'Firefox')
  hyperFocusOrOpen('e', 'Kiwi for Gmail')
  hyperFocusOrOpen('c', 'Calendar')
  hyperFocusOrOpen('a', 'Microsoft OneNote')
end
...
function setUpWindowManagement()
  ...
  local lowerHalf = hs.geometry("1,0 2x1")
